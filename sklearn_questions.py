...
class KNearestNeighbors(BaseEstimator, ClassifierMixin):
    ...
    def predict(self, X):
        ...
        neighbs_idx = distances.argsort(axis=1)[:, :self.n_neighbors]

        neighbs_labels = self.labels_[neighbs_idx]
        y_pred = np.squeeze(scipy.stats.mode(neighbs_labels, axis=1).mode)
        return y_pred
